    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="border p-3 max-w-4xl mx-auto py-7 flex flex-col gap-4">
            ...
            <div className="flex gap-5">
                <p className='bg-red-900 w-full max-w-[200px] text-white text-center p-1 rounded-md'>{listing.type === 'rent'? "For Rent": 
                "For Sale"
                }</p>
                {listing.offer && (
            ...
            <ul className='flex gap-4 text-green-700 items-center flex-wrap sm:gap-6'>
                <li className='flex gap-1 items-center whitespace-nowrap'><FaBed className='text-lg' /> 
                ...
                <li className='flex gap-1 items-center whitespace-nowrap'><FaChair className='text-lg' />
